...
execute at @e[type=minecraft:area_effect_cloud,tag=WR.delete] run function warp_relay:relay/forceload/remove
execute at @e[type=minecraft:area_effect_cloud,tag=WR.warp,tag=!WR.delete] run function warp_relay:relay/forceload/add
