...
execute if predicate warp_relay:classic_relay run function warp_relay:relay/create_classic
execute if predicate warp_relay:super_relay run function warp_relay:relay/create_super
...
#Cleanup
scoreboard players reset @s WR.index
